...
Like other Orone-mini, 1206 C1 is replaced with 7343-case size

Design Rules: OSHPark.com & Seeedstudio 'Fusion' PCB Service

Routing
Crystal tracks & Top Layer MCU tracks are 8mil/8mil to enable a wider range of PCB manufacturers to reliably make the board.
...
ROUND:   Signal
OCTAGON: Power (e.g. Vcc) or segregated Ground (e.g. AGND) and one ground via
...
Ventosus found the ADC was significantly 'noisier' than Maple-mini. So the ADC tracks are more thoroughly separated from other tracks.
